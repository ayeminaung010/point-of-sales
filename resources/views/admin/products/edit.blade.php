                ...
                <div class="col-lg-6 offset-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('admin#productUpdate') }}" enctype="multipart/form-data" method="post" novalidate="novalidate">
                                @csrf
                                <div class="form-group">
                                    <label for="" class="control-label mb-1">Name</label>
                                    <input id="" name="productName" type="text" value="{{ $products->name }}" class="form-control @error('productName') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Product name...">
                                    @error('productName')
                                        <small class=" invalid-feedback">{{ $message}}</small>
                                    @enderror
                                </div>
                                <input type="hidden"name='productId' value="{{ $products->id }}" name="">
                                <div class="form-group">
                                    ...
                                    <select name="productCategory"  id="" class="form-control @error('productCategory') is-invalid @enderror" >
                                        ...
                                        @foreach ($categories as $c)
                                            <option value="{{ $c->id }}" {{ ($products->category_id == $c->id ? "selected":"") }}> {{ $c->name}} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="productDescription" id="" class="form-control @error('productDescription') is-invalid @enderror" placeholder="Enter Description" cols="30" rows="10">{{ $products->description}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="" name="productWaitingTime" type="number" value="{{ $products->waiting_time }}" class="form-control @error('productWaitingTime') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder=" Waiting Time...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="" name="productPrice" type="number" value="{{ $products->price}}" class="form-control @error('productPrice') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Product price...">
                                    @error('productPrice')
                                        <small class=" invalid-feedback">{{ $message}}</small>
                                    @enderror
                                </div>
